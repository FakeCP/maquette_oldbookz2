            ...
            <div id="content">
                ...
                <?php
                        if (isset($_SESSION['error_update_editor']) && ($_SESSION['error_update_editor'] == true)) {
                            alert('danger', 'Erreur de saisie : éditeur non-ajouté à la base de données');
                ...
                <form action="action.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="denomination" class="form-control" id="exampleFormControlInput1">
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">SIRET</label>
                        <input type="text" name="siret" class="form-control" id="exampleFormControlInput1">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="numero_tel" class="form-control" id="exampleFormControlInput1">
                    </div>
                    <div class="mb-3 text-center">
                        <label for="exampleFormControlInput1" class="form-label"></label>
                        <input type="submit" name="btn_add_editor" class="btn btn-primary">
