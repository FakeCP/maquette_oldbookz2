...
$sql = 'SELECT utilisateur.id AS id_utilisateur, utilisateur.nom AS nom_utilisateur, utilisateur.prenom AS prenom_utilisateur,
utilisateur.mail AS mail_utilisateur, utilisateur.num_telephone AS num_telephone_utilisateur, utilisateur.pseudo AS pseudo_utilisateur,
utilisateur.nom AS nom_utilisateur, utilisateur.avatar AS avatar_utilisateur, utilisateur.adresse AS adresse_utilisateur, role.id AS id_role,
utilisateur.ville AS ville_utilisateur, utilisateur.code_postal AS code_postal_utilisateur, role.libelle AS libelle_role
FROM role_utilisateur INNER JOIN role ON role_utilisateur.id_utilisateur = role.id
                        ...
                        <tbody>
                            ...
                            <?php foreach ($utilisateurs as $utilisateur) : ?>
                                <tr>
                                    ...
                                    <td><img width="70px" height="70px" src="<?= URL_ADMIN ?>images/avatar/<?=$utilisateur['avatar_utilisateur']?>"</td>
